...
CORNER_GRID_TOOLTIP = (
    ...
    "lap crosses a gate drawn across the track at each edge — such cells were a median 0.22 s off "
    "(up to 0.89 s) on the owner's 38-lap recording before a September 2026 change to corner "
    "matching, as large as the mark itself, against 0.004 s for matched ones; that change left far "
    "fewer cells interpolated, and the figure has not been re-measured since. "
...
# clean laps (20,000 draws per N) falls 0.153 / 0.288 / 0.326 / 0.340 / 0.377 s per doubling of lap
