...
class PlotsView(QWidget):
    ...
    def _delta_series(self, draw_ids, baseline, delta, x_mode: str):
        ...
        it now ends at the whole gap, 1.37 s on D24 one chapter and 1.49 s on three.
    ...
    def _draw_ideal(self, x_mode: str):
        ...
        every recording. It now ends at the whole gap: −1.37 s on D24 one chapter and −1.49 s on
        three (−1.14 s on Sandown as last measured, before #300), drawn against a y=0 line that is
        the best lap.
