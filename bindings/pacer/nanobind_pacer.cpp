...
void py_init_module_pacer(nb::module_ &m) {
  ...
  auto pyClassGPMFSource =
      nb::class_<pacer::GPMFSource, pacer::RawGPSSource>
          (m, "GPMFSource", " A RawGPSSource backed by the GPMF metadata track of an MP4 container: opens\n the file and walks its GPS / IMU / orientation streams.")
