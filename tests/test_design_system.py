...
def test_no_studio_module_hand_picks_a_layout_dimension():
    ...
    EXEMPT: set[tuple[str, str]] = {
        ...
        # ONE entry for BOTH export pickers now: the overlay one and the distance-locked comparison
...
def test_no_table_header_floats_off_its_data():
    ...
    tables = {"LAPS": view.table.table, "CORNERS": view.corner_table.table,
              ...
              "STATS/SECTORS": stats.sector_table, "STATS/CORNERS": stats.corners.table,
              ...
              "STATS/COASTING": stats.coasting.table,
