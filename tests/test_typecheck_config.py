...
NOT_YET = {
    "_signal", "bests", "chapters", "coaching", "corner_model", "corners", "data_quality",
    "driving_channels", "export_data", "focus", "gmeter", "ingest", "library", "marks", "prefs",
    "provenance", "reference", "scrub_controller", "session", "session_record", "stats",
    "timeline", "track_db",
}
