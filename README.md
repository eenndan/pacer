...
- **134 CTest registrations** — Catch2 over the C++ core, plus offscreen Qt suites that build real
  ...
  end-to-end offscreen smoke on every pull request — except the twelve `footage.*` checks, which
